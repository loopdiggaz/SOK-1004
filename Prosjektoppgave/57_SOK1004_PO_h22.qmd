...
Jeg har hentet historiske data fra SSB: <https://www.ssb.no/a/histstat>), og oppgaven bygger på disse dataene. Statistikken knyttet arbeidsledighet er fra folke og boligtellinger, og er publisert i serien Norges offisielle statistikk.

Oppgaven bruker begrepene ikke yrkesaktiv og arbeidsledig om en annen når den beskriver arbeidsledighet. Jeg tar utgangspunkt i BNP per person når jeg beskriver den økonomiske veksten, her må vi ikke glemme at indeksen regner om til et enkelt tall, og at en slik utregning kan gjøres på mange forskjellige måter.
